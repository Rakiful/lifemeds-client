...
import { FaUsers, FaStore, FaShoppingCart, FaDollarSign, FaCapsules } from "react-icons/fa";
    ...
    <div className="p-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-10">
        <div className="bg-white shadow-md rounded-xl p-6 flex items-center gap-3">
          <FaCapsules className="text-5xl text-orange-500" />
          <div>
        ...
        <div className="bg-white shadow-md rounded-xl p-6 flex items-center gap-3">
          <FaStore className="text-5xl text-red-500" />
          <div>
            <h4 className="text-lg font-semibold">Sellers</h4>
        ...
        <div className="bg-white shadow-md rounded-xl p-6 flex items-center gap-3">
          <FaDollarSign className="text-5xl text-yellow-600" />
          <div>
        ...
        <div className="bg-white shadow-md rounded-xl p-6 flex items-center gap-3">
          <FaDollarSign className="text-5xl text-purple-600" />
          <div>
